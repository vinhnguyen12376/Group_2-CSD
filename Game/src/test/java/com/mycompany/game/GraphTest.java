...
public class GraphTest {
    ...
    public void testLoadMapFromFile() {
        ...
        graph.addRoom(new Room(3, "R3", null, null));
        graph.addRoom(new Room(4, "R4", null, null));
        graph.addRoom(new Room(5, "R5", null, null));
        graph.addRoom(new Room(6, "R6", null, null));
        graph.addRoom(new Room(7, "R7", null, null));
        graph.addRoom(new Room(8, "R8", null, null));
